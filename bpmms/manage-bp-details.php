...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['memberAge'];?></td>
                                             <td><?php echo $row['systolic'];?>/<?php echo $row['diastolic'];?></td>
                                ...
                                <a href="manage-bp-details.php?bpid=<?php echo $row['bpid'];?>&&action=delete" onclick="return confirm('Do you really want to delete this record?');"><i class="fa fa-trash" aria-hidden="true" style="color:red" title="Delete this record"></i></a></td>
                                        </tr>
                               <?php } ?>
                                    </tbody>
                                </table>
