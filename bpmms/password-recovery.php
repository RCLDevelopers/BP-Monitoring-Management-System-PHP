...
$query=mysqli_query($con,"select id from tbluserregistration where  emailid='$emailid' and mobileNumber='$contactno' ");
...
<head>
    ...
    <title>BP Monitoring Management System  | Password Recovery</title>
...
<body class="bg-gradient-primary">
 ...
 <h3 align="center" style="margin-top:4%;color:#fff">BP Monitoring Management System </h3>
