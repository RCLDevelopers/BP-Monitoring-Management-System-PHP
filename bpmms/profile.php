...
if (strlen($_SESSION['aid']==0)) {
  ...
  $mobno=$_POST['mobilenumber'];
     ...
     $query=mysqli_query($con, "update tbluserregistration set fullName='$fname', mobileNumber ='$mobno'  where id='$uid'");
    if ($query) {
...
<head>
    ...
    <title>BP Monitoring  Management System| User Profile</title>
...
<?php include_once('includes/sidebar.php');?>
  ...
  <div class="row">
                ...
                <?php
$uid=$_SESSION['aid'];
$ret=mysqli_query($con,"select * from tbluserregistration where id='$uid'");
$cnt=1;
...
?>
     ...
     <div class="form-group">
           ...
           <input type="text" class="form-control" name="fullname" value="<?php  echo $row['fullName'];?>" required='true'>
                        ...
                        <div class="form-group">
                            <label>Email Id <small>(used for login)</small></label>
